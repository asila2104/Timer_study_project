...
class TimerInitial extends TimerState {
  const TimerInitial(String timeStr, double percent)
      : super(timeStr, percent, false);
...
class TimerRunState extends TimerState {
  const TimerRunState(String timeStr, double percent)
      : super(timeStr, percent, true);
...
class TimerPauseState extends TimerState {
  const TimerPauseState(String timeStr, double percent)
      : super(timeStr, percent, false);
...
class TimerResetState extends TimerState {
  const TimerResetState(String timeStr, double percent, bool isRun)
      : super(timeStr, percent, isRun);
